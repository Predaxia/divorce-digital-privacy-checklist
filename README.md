...
- [ ] Understand the legal line. Deleting data after legal proceedings become reasonably foreseeable can be held against you in court. Before that point, it is not spoliation. Know where the line is before you act. [What counts as deleting evidence vs protecting yourself](https://predaxia.com/deleting-evidence-vs-protecting-yourself/)

- [ ] Check whether your phone is monitored. Battery drain, background data spikes, unexpected warmth, notification anomalies. Eight symptoms are reliably documented across multiple spyware products and are detectable without technical expertise. [8 signs your phone is being monitored](https://predaxia.com/is-your-phone-being-monitored/)

- [ ] Assume your devices are already compromised. If your spouse had physical access to your phone for five minutes at any point in the last six months, operate on the assumption that a monitoring app is installed. [Why you should assume your devices are compromised before filing](https://predaxia.com/filing-for-divorce-assume-devices-compromised/)
...
- [ ] Set a strong password on the new device. 16 characters minimum, alphanumeric. Not a 4-digit PIN. Not Face ID alone. A [7-character password was cracked in 6 hours](https://predaxia.com/device-seized-what-they-can-extract/) in a documented federal case using forensic tools.
...
- [ ] Enable two-factor authentication on every account. Use an authenticator app, not SMS. [SMS codes can be intercepted in real time](https://predaxia.com/sms-codes-intercepted-ss7/) through documented attacks on the SS7 protocol.
...
- [ ] Your phone carrier sells your location data. This is [documented, not alleged](https://predaxia.com/phone-carrier-sells-location-data/). AT&T, T-Mobile, and Verizon sold real-time location data to third-party aggregators for years. The FCC issued fines. Consider whether your carrier account is in your spouse's name.
...
- [ ] Stop posting about travel, purchases, lifestyle, or new relationships. [Judges use Instagram posts as evidence](https://predaxia.com/judges-using-instagram-against-you/) in family court. Posts showing spending inconsistent with financial disclosures are regularly submitted as exhibits.

- [ ] Screenshot anything your spouse has posted that may be relevant to your case. Do it now, before they delete it.

- [ ] Understand that your [digital footprint](https://predaxia.com/glossary/digital-footprint/) extends beyond social media. Search engine history, purchase history, app usage patterns. All of it is potentially discoverable.
...
- [ ] Be aware that [email metadata reveals more than content](https://predaxia.com/journalist-arrested-because-of-email/). Who you contacted, when, and how often. The content can be encrypted. The metadata usually cannot.
...
- [ ] Use a [password manager](https://predaxia.com/1password-review-for-journalists/) on the new device only. Never use the browser's built-in password save feature on a shared device.
...
- [ ] Submit opt-out requests to the major data brokers. The manual process is free and covers the same brokers as paid services. [How to remove yourself from data broker sites](https://predaxia.com/remove-yourself-data-broker-sites-free/)

- [ ] If your safety is at risk, consider a paid removal service like [DeleteMe](https://predaxia.com/deleteme-review-2026/) that monitors for re-listing and automates the opt-out cycle.
...
[How to build your threat model in 20 minutes](https://predaxia.com/how-to-build-threat-model/)

---

## Complete glossary

59 OPSEC and privacy terms explained for non-technical users: [predaxia.com/glossary](https://predaxia.com/glossary/)

---

## About Predaxia

[Predaxia](https://predaxia.com) is an independent publication covering operational security for civilians. We test tools under real conditions, document field failures, and write for people whose privacy is not theoretical.
